...
var Core = /** @class */ (function () {
    ...
    Core.prototype.start = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                this.configuration.operations.forEach(function (operation) { return __awaiter(_this, void 0, void 0, function () {
                    var _this = this;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
                                    return __generator(this, function (_a) {
                                        switch (_a.label) {
                                            case 0: return [4 /*yield*/, this.processOperation(operation)];
                                            case 1:
                                                _a.sent();
                                                return [2 /*return*/];
                                        }
     ...
     * @param operation
     */
    Core.prototype.processOperation = function (operation) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _a = this.processOutput;
                        _b = [operation.output];
                        return [4 /*yield*/, this.processInput(operation.input)];
